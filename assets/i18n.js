(function () {
  ...
  const messages = {
    'ubuntu.commonTools': ['常用工具', 'Favorite tools'],
    'ubuntu.allApps': ['全部应用', 'All applications'],
    'ubuntu.closeApps': ['关闭全部应用', 'Close all applications'],
    'ubuntu.appLinks': ['应用入口', 'Applications'],
    'ubuntu.allToolsLink': ['全部工具 →', 'All tools →'],
    'ubuntu.qrShortcut': ['二维码', 'QR codes'],
    'ubuntu.textShortcut': ['文本工具', 'Text tools'],
    'ubuntu.desktop': ['显示桌面', 'Show desktop'],
    'ubuntu.launcher': ['快捷启动', 'Quick launch'],
    'ubuntu.home': ['主页', 'Home'],
    'ubuntu.tools': ['在线工具', 'Online tools'],
    'ubuntu.appearance': ['外观设置', 'Appearance'],
    'ubuntu.back': ['后退', 'Back'],
    'ubuntu.forward': ['前进', 'Forward'],
    'ubuntu.navigation': ['打开导航', 'Open navigation'],
    'ubuntu.minimize': ['最小化窗口', 'Minimize window'],
    'ubuntu.maximize': ['最大化窗口', 'Maximize window'],
    'ubuntu.close': ['收起窗口，显示桌面', 'Hide window and show desktop'],
    'ubuntu.more': ['更多内容', 'More pages'],
    'ubuntu.stories': ['阅读与游戏', 'Reading and games'],
    'ubuntu.footer': ['页脚导航', 'Footer navigation'],
    ...
    'games.lede': ['13 款小游戏都在这里，选一款直接开始。', 'All thirteen games are here. Pick one and start playing.'],
    'games.freeKick': ['弧线任意球', 'Curve Free Kick'],
    'games.freeKickNote': ['选择击球点、角度与力度，借风势绕过人墙，挑战门将的 3D 任意球射门。', 'Choose the contact point, aim and power to bend a free kick past the wall and goalkeeper.'],
    'games.stormSiege': ['风暴攻城', 'Storm Siege'],
    'games.stormSiegeNote': ['调整炮口角度、力度和引信，借风势击毁敌方城堡的 3D 攻城战。', 'Aim your cannon, set its power and fuse, and use the wind to bring down the enemy castle in 3D.'],
    'games.threeKingdomsBaye': ['三国霸业', 'Three Kingdoms: Baye'],
    'games.threeKingdomsBayeNote': ['步步高电子词典经典策略游戏，词典原版完整移植，支持键盘和触屏操作。', 'The classic BBK dictionary strategy game, ported with keyboard and touch controls.'],
    ...
    'games.frontline': ['前线指挥', 'Frontline Command'],
    'games.frontlineNote': ['采集蓝晶、生产装甲部队，在原创 HTML5 战场上摧毁敌方指挥部。', 'Harvest crystals, build armored units, and destroy the enemy command center in an original HTML5 battlefield.'],
    'games.starDefense': ['星环塔防', 'Star Ring Defense'],
    'games.starDefenseNote': ['在发光基座布置三类炮塔，升级火力并守住八波机械虫群。', 'Build three tower types, upgrade your firepower, and survive eight waves of machines.'],
