...
(() => {
  ...
  const titles = {
    ...
    'gomoku':['五子棋','Gomoku'], 'chinese-chess':['中国象棋','Chinese chess'], 'junqi':['军棋','Junqi'], 'frontline-command':['前线指挥','Frontline Command'], 'tower-defense':['星环塔防','Star Ring Defense'], 'storm-siege':['风暴攻城','Storm Siege'], 'free-kick':['弧线任意球','Curve Free Kick'], 'three-kingdoms-baye':['三国霸业','Three Kingdoms: Baye'], 'tetris':['俄罗斯方块','Tetris'], 'fruit-ninja':['水果忍者','Fruit Ninja'], 'submarine-battle':['潜艇大战','Deep Sea Hunter'], 'parking-pulse':['停车脉冲','Parking Pulse'], 'sand-sort':['沙子分类','Sand Sort']
  };
